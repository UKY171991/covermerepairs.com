...
class Part_corntroller extends CI_Controller {
	...
	public function add_data(){
		...
		if($this->input->post()){
            ...
            if($id !=''){
                ...
                $mes=array('status'=>"success",'message'=>'Part Controller updated successfully.');
                echo json_encode($mes);
                exit();
            }else{
                ...
                $mes=array('status'=>"success",'message'=>'Part Controller added successfully.');
                echo json_encode($mes);
                exit();
            }
    ...
    public function delete(){
        ...
        echo "Part Controller deleted successfully.";
        exit();
    }
