  ...
  <div class="modal fade" id="edit_data">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="<?=base_url('users/add_data')?>" method="post" id="submit_data" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label>Branch</label>
				  <select name="standred[]" class="form-control standred select2" multiple required>
					<!--<option value="">Select standred</option> -->
