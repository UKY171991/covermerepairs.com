  ...
  <div class="content-wrapper" style="background-image: url(<?=base_url('assets/custom/new_one_dash.jpg')?>); background-repeat: no-repeat; background-size: cover;">
    ...
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Parts & Price</h1> 
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Parts & Price</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <?php if($this->session->userdata('user_type') !='1' AND $this->session->userdata('user_type') !='2' ){ ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="price_min" class="form-control price_min" placeholder="" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="price_max" class="form-control price_max" placeholder="">
                </div>
              </div>
