...
<style>
  ...
  .signature-table td { border: none; font-size: 15px; }
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <table class="pdf-header-table" style="margin-top:20px;">
        <tr>
          <td class="logo-cell">
            <img src="<?= base_url('assets/dist/img/mobile_logo.jpg') ?>" style="height:120px; width:120px; border-radius: 50%; object-fit: cover;">
          </td>
      ...
      <div class="col-md-12">
        <p><strong>Loan Device</strong></p>
        <p>The customer must return the loan device in good condition after the repair. Failing to comply will forfeit the deposit fee.</p>
      </div>
      <div class="static-box">
