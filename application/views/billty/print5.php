    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>HO Copy</h1> 
            <h1><input type='button' id='btn' value='Print' onclick='printDiv_5();'></h1> 
          </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header" id="print_data_5" style="background: #cfd9c1;">
...
<script type="text/javascript">
  ...
  function printDiv_5() 
  {
    ...
    var divToPrint=document.getElementById('print_data_5');
