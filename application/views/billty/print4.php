      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1><input type='button' id='btn' value='Print' onclick='printDiv_4();'></h1> 
          </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header" id="print_data_4" style="background: #cfb848;">
...
<script type="text/javascript">
  ...
  function printDiv_4() 
  {
    ...
    var divToPrint=document.getElementById('print_data_4');
