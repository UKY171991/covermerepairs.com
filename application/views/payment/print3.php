  ...
  <div class="content-wrapper"  style="background:#e3a4b9">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>HO COPY</h1> 
            <h1><input type='button' id='btn' value='Print' onclick='printDiv_3();'></h1> 
          </div>
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header" id="print_data_3" style="background:#e3a4b9">
                    ...
                    <div class="col-xs-7 col-sm-7 col-md-7 border">
                      <div class="row">
                        ...
                        <div class="col-xs-7 col-sm-7 col-md-7">
                          <h2 class="text-center">FREIGHT CHALLAN HO COPY</h2><br>
...
<script type="text/javascript">
  ...
  function printDiv_3() 
  {
    ...
    var divToPrint=document.getElementById('print_data_3');
