              ...
              <div class="card-header" id="print_data_1">
                 <!-- <h3 class="card-title">DataTable with default features</h3> -->
                    ...
                    <div class="col-xs-7 col-sm-7 col-md-7 border">
                      <div class="row">
                        ...
                        <div class="col-xs-7 col-sm-7 col-md-7">
                          <h2 class="text-center">FREIGHT CHALLAN DRIVER/OWNER COPY</h2><br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4 border">
                          <strong>Balance at Branch & Phone :- <br></strong> <?=$challan[0]->balance_at_branch_phone;?>
                    </div>
                  </div>
